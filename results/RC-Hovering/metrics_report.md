...
| Percentage of time with horizontal velocity below 0.1 m/s | `100 * count(vxy < 0.1) / count(vxy)` | cleaned Vicon GT twist X/Y |
...
![AI P99 absolute yaw rate](20s/AI/plots/metric_07_p99_absolute_yaw_rate.png)

#### Minimum roll angle

![AI Minimum roll angle](20s/AI/plots/metric_08_minimum_roll_angle.png)

#### Maximum roll angle

![AI Maximum roll angle](20s/AI/plots/metric_09_maximum_roll_angle.png)

#### Peak absolute roll angle

![AI Peak absolute roll angle](20s/AI/plots/metric_10_peak_absolute_roll_angle.png)

#### Minimum relative pitch angle

![AI Minimum relative pitch angle](20s/AI/plots/metric_11_minimum_relative_pitch_angle.png)

#### Maximum relative pitch angle

![AI Maximum relative pitch angle](20s/AI/plots/metric_12_maximum_relative_pitch_angle.png)

#### Maximum absolute pitch angle

![AI Maximum absolute pitch angle](20s/AI/plots/metric_13_maximum_absolute_pitch_angle.png)

#### Maximum absolute yaw excursion

![AI Maximum absolute yaw excursion](20s/AI/plots/metric_14_maximum_absolute_yaw_excursion.png)

#### Yaw range

![AI Yaw range](20s/AI/plots/metric_15_yaw_range.png)

#### Median horizontal velocity

![AI Median horizontal velocity](20s/AI/plots/metric_16_median_horizontal_velocity.png)

#### P95 horizontal velocity

![AI P95 horizontal velocity](20s/AI/plots/metric_17_p95_horizontal_velocity.png)

#### Percentage of time with horizontal velocity below 0.1 m/s

![AI Percentage of time with horizontal velocity below 0.1 m/s](20s/AI/plots/metric_18_percentage_of_time_with_horizontal_velocity_below_0_1_m_s.png)
...
![RAW P99 absolute yaw rate](20s/RAW/plots/metric_07_p99_absolute_yaw_rate.png)

#### Minimum roll angle

![RAW Minimum roll angle](20s/RAW/plots/metric_08_minimum_roll_angle.png)

#### Maximum roll angle

![RAW Maximum roll angle](20s/RAW/plots/metric_09_maximum_roll_angle.png)

#### Peak absolute roll angle

![RAW Peak absolute roll angle](20s/RAW/plots/metric_10_peak_absolute_roll_angle.png)

#### Minimum relative pitch angle

![RAW Minimum relative pitch angle](20s/RAW/plots/metric_11_minimum_relative_pitch_angle.png)

#### Maximum relative pitch angle

![RAW Maximum relative pitch angle](20s/RAW/plots/metric_12_maximum_relative_pitch_angle.png)

#### Maximum absolute pitch angle

![RAW Maximum absolute pitch angle](20s/RAW/plots/metric_13_maximum_absolute_pitch_angle.png)

#### Maximum absolute yaw excursion

![RAW Maximum absolute yaw excursion](20s/RAW/plots/metric_14_maximum_absolute_yaw_excursion.png)

#### Yaw range

![RAW Yaw range](20s/RAW/plots/metric_15_yaw_range.png)

#### Median horizontal velocity

![RAW Median horizontal velocity](20s/RAW/plots/metric_16_median_horizontal_velocity.png)

#### P95 horizontal velocity

![RAW P95 horizontal velocity](20s/RAW/plots/metric_17_p95_horizontal_velocity.png)

#### Percentage of time with horizontal velocity below 0.1 m/s

![RAW Percentage of time with horizontal velocity below 0.1 m/s](20s/RAW/plots/metric_18_percentage_of_time_with_horizontal_velocity_below_0_1_m_s.png)
