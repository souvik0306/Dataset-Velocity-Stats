#!/usr/bin/env python3
"""Run Super-High Motion Metrics for the configured AI and RAW flight windows."""
...
DATASETS = {
    "AI": {
        "folder": "AI",
        "window_starts_s": (41.14, 40.24, 37.5, 38.23),
    },
}
...
def main() -> None:
    ...
    parser.add_argument("root", nargs="?", default='data/Super-High')
    parser.add_argument("-o", "--output-dir", default='results/Super-High')
    ...
    run_group(Path(args.root).expanduser().resolve(),
              ...
              title='Super-High Motion Metrics', include_yaw=False)
