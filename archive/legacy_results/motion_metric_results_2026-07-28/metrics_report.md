...
- Metrics are computed only inside the evaluation windows from Vicon Cutoff+5s until 10s.
...
- Combined CSV: [UN_RAW_average_comparison.csv](UN_RAW_average_comparison.csv)

### UN

- Flights processed: 7
- CSV: [UN/metrics.csv](UN/metrics.csv)
...
- Flights processed: 7
- CSV: [RAW/metrics.csv](RAW/metrics.csv)
